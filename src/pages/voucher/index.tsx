...
const VocherScreenIndex = dynamic(() => import('@/containers/voucher-screen/voucher-screen-index/voucher-screen-index'), { ssr: true });

const VocherScreen: NextPage = () => {
  return (
    <>
      <Head>
