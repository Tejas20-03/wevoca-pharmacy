...
const ShippingPolicyIndex = dynamic(() => import('@/containers/shipping-policy/shipping-policy-index/shipping-policy-index'), { ssr: true });
    ...
    return (
        <>
            <Head>
                ...
                <title>Shipping policy — TEMP®</title>
            </Head>
